  ...
  <?php if( get_theme_mod( 'the_wp_fitness_slider_hide') != '') { ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod('the_wp_fitness_slider_speed',3000)); ?>"> 
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <?php if ( get_theme_mod('the_wp_fitness_slider_title',true) != '' ) {?>
                    <h1><?php the_title(); ?></h1>
                  <?php }?> 
                  <?php if ( get_theme_mod('the_wp_fitness_slider_button_label','READ MORE') != '' && get_theme_mod('the_wp_fitness_slider_button',true) != ''|| get_theme_mod('the_wp_fitness_slider_button_link') != '') {?>
                    <div class ="read-more">
                      <a href="<?php echo esc_url(get_theme_mod('the_wp_fitness_slider_button_link')!= '') ? esc_url(get_theme_mod('the_wp_fitness_slider_button_link')) : esc_url(get_permalink()); ?>"><?php echo esc_html( get_theme_mod('the_wp_fitness_slider_button_label',__('READ MORE','the-wp-fitness')) ); ?><i class="fas fa-arrow-right p-1"></i><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('the_wp_fitness_slider_button_label',__('READ MORE','the-wp-fitness')) ); ?></span></a>
                    </div> 
                  <?php }?>                   
                </div>
              </div>
        ...
        <?php if(get_theme_mod('the_wp_fitness_slider_arrow_hide_show', true)){?>
          <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"><i class="<?php echo esc_attr(get_theme_mod('the_wp_fitness_slider_prev_icon','fas fa-caret-left')); ?>"></i></span>
            <span class="screen-reader-text"><?php echo esc_html_e('Previous','the-wp-fitness'); ?></span>
          </a>
          <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"><i class="<?php echo esc_attr(get_theme_mod('the_wp_fitness_slider_next_icon','fas fa-caret-right')); ?>"></i></span>
