				...
				<div class="col-lg-4 col-md-4">
					<article class="blog-sec p-2 mb-4">
					    ...
					    <?php if(get_the_excerpt()) { ?>
					        <div class="entry-content"><p class="m-0"><?php $the_wp_fitness_excerpt = get_the_excerpt(); echo esc_html( the_wp_fitness_string_limit_words( $the_wp_fitness_excerpt, esc_attr(get_theme_mod('the_wp_fitness_related_post_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('the_wp_fitness_button_excerpt_suffix','...') ); ?></p></div>
					    <?php }?>
