...
function the_wp_fitness_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('the_wp_fitness_call_icon',array(
		'default'	=> 'fa fa-phone',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new the_wp_fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_call_icon',array(
		'label'	=>__('Add Phone Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_topbar_icon',
		'setting'	=> 'the_wp_fitness_call_icon',
		'type'		=> 'icon',
	)));
	...
	$wp_customize->add_setting('the_wp_fitness_mail_icon',array(
		'default'	=> 'fa fa-envelope',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new the_wp_fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_mail_icon',array(
		'label'	=>__('Add Email Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_topbar_icon',
		'setting'	=> 'the_wp_fitness_mail_icon',
		'type'		=> 'icon',
	)));
	...
	$wp_customize->add_setting('the_wp_fitness_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_menu_color', array(
		'label'    => __('Menu Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_header',
		'settings' => 'the_wp_fitness_menu_color',
	)));

	$wp_customize->add_setting('the_wp_fitness_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_menu_hover_color', array(
		'label'    => __('Menu Hover Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_header',
		'settings' => 'the_wp_fitness_menu_hover_color',
	)));

	$wp_customize->add_setting('the_wp_fitness_submenu_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_submenu_menu_color', array(
		'label'    => __('Submenu Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_header',
		'settings' => 'the_wp_fitness_submenu_menu_color',
	)));

	$wp_customize->add_setting('the_wp_fitness_submenu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_submenu_hover_color', array(
		'label'    => __('Submenu Hover Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_header',
		'settings' => 'the_wp_fitness_submenu_hover_color',
	)));

	$wp_customize->add_setting( 'the_wp_fitness_menu_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('the_wp_fitness_menu_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>Premium Theme Features!</h3>
            ...
            <a target='_blank' href='". esc_url('https://www.themesglance.com/premium/fitness-wordpress-theme/') ." '>Upgrade Now</a>",
        'section' => 'the_wp_fitness_header'
        )
    );
	...
	$wp_customize->add_setting( 'the_wp_fitness_slider_arrow_hide_show',array(
	    'default' => true,   
	    'sanitize_callback' => 'the_wp_fitness_sanitize_checkbox'
	));
	$wp_customize->add_control( 'the_wp_fitness_slider_arrow_hide_show',array(
		'label' => esc_html__( 'Show / Hide Slider Arrows','the-wp-fitness' ),
		'section' => 'the_wp_fitness_slidersettings',
		'type' => 'checkbox',
	));

	$wp_customize->add_setting('the_wp_fitness_slider_prev_icon',array(
		'default'	=> 'fas fa-caret-left',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new the_wp_fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_slider_prev_icon',array(
		'label'	=>__('Add Slider Prev Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_slidersettings',
		'setting'	=> 'the_wp_fitness_slider_prev_icon',
		'type'		=> 'icon',
	)));

	$wp_customize->add_setting('the_wp_fitness_slider_next_icon',array(
		'default'	=> 'fas fa-caret-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new the_wp_fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_slider_next_icon',array(
		'label'	=> __('Add Slider Next Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_slidersettings',
		'setting'	=> 'the_wp_fitness_slider_next_icon',
		'type'		=> 'icon',
	)));

	 $wp_customize->add_setting('the_wp_fitness_slider_arrows_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_slider_arrows_hover_color', array(
		'label'    => __('Slider Arrows hover Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_slidersettings',
		'settings' => 'the_wp_fitness_slider_arrows_hover_color',
	)));
	...
	$wp_customize->add_setting('the_wp_fitness_slider_button_link',array(
        'default'=> '',
        'sanitize_callback' => 'esc_url_raw'
    ));
    $wp_customize->add_control('the_wp_fitness_slider_button_link',array(
        'label' => esc_html__('Add Button Link','the-wp-fitness'),
        'section'=> 'the_wp_fitness_slidersettings',
        'type'=> 'url'
    ));

	$wp_customize->add_setting('the_wp_fitness_slider_btn_color', array(
	'default'           => '',
	'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_slider_btn_color', array(
		'label'    => __('Slider Button Lable Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_slidersettings',
		'settings' => 'the_wp_fitness_slider_btn_color',
	)));

	$wp_customize->add_setting('the_wp_fitness_slider_btn_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_slider_btn_bg_color', array(
		'label'    => __('Slider Button Bg Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_slidersettings',
		'settings' => 'the_wp_fitness_slider_btn_bg_color',
	)));

    $wp_customize->add_setting('the_wp_fitness_slider_btn_lable_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_slider_btn_lable_hover_color', array(
		'label'    => __('Slider Button Lable hover Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_slidersettings',
		'settings' => 'the_wp_fitness_slider_btn_lable_hover_color',
	)));

	$wp_customize->add_setting('the_wp_fitness_slider_btn_bg_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_slider_btn_bg_hover_color', array(
		'label'    => __('Slider Button Bg hover Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_slidersettings',
		'settings' => 'the_wp_fitness_slider_btn_bg_hover_color',
	)));
	...
	$wp_customize->add_setting( 'the_wp_fitness_trainer_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('the_wp_fitness_trainer_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>Premium Theme Features!</h3>
            <ul>
    ...
    $wp_customize->add_setting('the_wp_fitness_blog_post_alignment',array(
        'default' => 'left',
        'sanitize_callback' => 'the_wp_fitness_sanitize_choices'
    ));
	$wp_customize->add_control('the_wp_fitness_blog_post_alignment', array(
        'type' => 'select',
        'label' => __( 'Blog Post Alignment', 'the-wp-fitness' ),
        'section' => 'the_wp_fitness_theme_layout',
        'choices' => array(
            'left' => __('Left Align','the-wp-fitness'),
            'right' => __('Right Align','the-wp-fitness'),
            'center' => __('Center Align','the-wp-fitness')
        ),
    ));
    ...
    $wp_customize->add_setting('the_wp_fitness_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_theme_layout',
		'setting'	=> 'the_wp_fitness_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('the_wp_fitness_postauthor_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_postauthor_icon',array(
		'label'	=> __('Add Post Author Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('the_wp_fitness_postcomment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_postcomment_icon',array(
		'label'	=> __('Add Post Comments Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('the_wp_fitness_posttime_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_posttime_icon',array(
		'label'	=> __('Add Post Time Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_theme_layout',
		'type'		=> 'icon'
	)));
   ...
   $wp_customize->add_setting( 'the_wp_fitness_post_excerpt_number', array(
	...
	//Featured Image
	$wp_customize->add_setting('the_wp_fitness_blog_image_dimension',array(
       'default' => 'default',
       'sanitize_callback'	=> 'the_wp_fitness_sanitize_choices'
    ));
    $wp_customize->add_control('the_wp_fitness_blog_image_dimension',array(
       'type' => 'radio',
       'label'	=> __('Blog Post Featured Image Dimension','the-wp-fitness'),
       'choices' => array(
            'default' => __('Default','the-wp-fitness'),
            'custom' => __('Custom Image Size','the-wp-fitness'),
        ),
      	'section'	=> 'the_wp_fitness_theme_layout',
    ));

    $wp_customize->add_setting( 'the_wp_fitness_feature_image_custom_width', array(
		'default'=> '250',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( new The_WP_Fitness_WP_Customize_Range_Control( $wp_customize, 'the_wp_fitness_feature_image_custom_width', array(
        'label'  => __('Featured Image Custom Width','the-wp-fitness'),
        'section'  => 'the_wp_fitness_theme_layout',
        'description' => __('Measurement is in pixel.','the-wp-fitness'),
        'input_attrs' => array(
            'min' => 0,
		...
		'active_callback' => 'the_wp_fitness_blog_image_dimension'
    )));

    $wp_customize->add_setting( 'the_wp_fitness_feature_image_custom_height', array(
		'default'=> '250',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( new The_WP_Fitness_WP_Customize_Range_Control( $wp_customize, 'the_wp_fitness_feature_image_custom_height', array(
        'label'  => __('Featured Image Custom Height','the-wp-fitness'),
        'section'  => 'the_wp_fitness_theme_layout',
        'description' => __('Measurement is in pixel.','the-wp-fitness'),
        'input_attrs' => array(
            'min' => 0,
    ...
    $wp_customize->add_setting( 'the_wp_fitness_post_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('the_wp_fitness_post_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>Premium Theme Features!</h3>
            <ul>
    ...
    $wp_customize->add_setting('the_wp_fitness_singlepost_date_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_singlepost_date_icon',array(
		'label'	=> __('Add Single Post Date Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_single_post_settings',
		'setting'	=> 'the_wp_fitness_singlepost_date_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('the_wp_fitness_singlepost_author_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_singlepost_author_icon',array(
		'label'	=> __('Add Single Post Author Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('the_wp_fitness_single_post_comment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_single_post_comment_icon',array(
		'label'	=> __('Add Single Post Comments Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('the_wp_fitness_single_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new The_Wp_Fitness_Icon_Selector(
        $wp_customize,'the_wp_fitness_single_post_time_icon',array(
		'label'	=> __('Add Single Post Time Icon','the-wp-fitness'),
		'transport' => 'refresh',
		'section'	=> 'the_wp_fitness_single_post_settings',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('the_wp_fitness_single_post_metabox_seperator',array(
       'default' => '|',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('the_wp_fitness_single_post_metabox_seperator',array(
       'type' => 'text',
       'label' => __('Metabox Seperator','the-wp-fitness'),
       'description' => __('Ex: "/", "|", "-", ...','the-wp-fitness'),
       'section' => 'the_wp_fitness_single_post_settings'
    ...
    $wp_customize->add_setting('the_wp_fitness_single_post_category',array(
       'default' => 'true',
       'sanitize_callback'	=> 'the_wp_fitness_sanitize_checkbox'
    ));
    $wp_customize->add_control('the_wp_fitness_single_post_category',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Single Post Category','the-wp-fitness'),
       'section' => 'the_wp_fitness_single_post_settings'
    ));
    ...
    $wp_customize->add_setting( 'the_wp_fitness_single_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'the_wp_fitness_sanitize_float',
	) );
	$wp_customize->add_control( 'the_wp_fitness_single_post_img_border_radius', array(
		'label'       => esc_html__( 'Single Post Image Border Radius','the-wp-fitness' ),
		'section'     => 'the_wp_fitness_single_post_settings',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'the_wp_fitness_single_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'the_wp_fitness_sanitize_float',
	));
	$wp_customize->add_control('the_wp_fitness_single_post_img_box_shadow',array(
		'label' => esc_html__( 'Single Post Image Shadow','the-wp-fitness' ),
		'section' => 'the_wp_fitness_single_post_settings',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
    ...
    $wp_customize->add_setting( 'the_wp_fitness_related_post_excerpt_number',array(
		'default' => 20,
		'sanitize_callback' => 'the_wp_fitness_sanitize_float'
	));

	$wp_customize->add_control('the_wp_fitness_related_post_excerpt_number',	array(
		'label' => esc_html__( 'Related Posts Content Limit','the-wp-fitness' ),
		'section' => 'the_wp_fitness_single_post_settings',
		'type'    => 'number',
	 	'settings' => 'the_wp_fitness_related_post_excerpt_number',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
			'step' => 1,
    ...
    // font size button
 	$wp_customize->add_setting( 'the_wp_fitness_button_font_size',array(
		'default' => '16',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control( new the_wp_fitness_WP_Customize_Range_Control( $wp_customize, 'the_wp_fitness_button_font_size', array(
		'label'  => __('Button Font Size','the-wp-fitness'),
		'section'  => 'the_wp_fitness_button_options',
		'description' => __('Measurement is in pixel.','the-wp-fitness'),
		'input_attrs' => array(
		   'min' => 0,
 	...
 	$wp_customize->add_setting('the_wp_fitness_button_font_weight',array(
    'default' => '',
    'sanitize_callback' => 'the_wp_fitness_sanitize_choices'
	));
	$wp_customize->add_control('the_wp_fitness_button_font_weight',array(
	    'type' => 'select',
	    'label' => __('Button Font Weight','the-wp-fitness'),
	    'section' => 'the_wp_fitness_button_options',
	    'choices' => array(
	       '100' => __('100','the-wp-fitness'),
	       '200' => __('200','the-wp-fitness'),
	...
	$wp_customize->add_setting('the_wp_fitness_button_text_transform',array(
        'default' => '',
        'sanitize_callback' => 'the_wp_fitness_sanitize_choices'
  	));
  	$wp_customize->add_control('the_wp_fitness_button_text_transform',array(
        'type' => 'select',
        'label' => __('Button Text transform','the-wp-fitness'),
        'section' => 'the_wp_fitness_button_options',
        'choices' => array(
            'uppercase' => __('Uppercase','the-wp-fitness'),
            'capitalize' => __('Capitalize','the-wp-fitness'),
            'lowercase' => __('lowercase','the-wp-fitness'),
        ),
  	) );
	...
	$wp_customize->add_setting( 'the_wp_fitness_single_page_breadcrumb',array(
		'default' => true,
      	'sanitize_callback'	=> 'the_wp_fitness_sanitize_checkbox'
    ) );
    $wp_customize->add_control('the_wp_fitness_single_page_breadcrumb',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Single Page Breadcrumb','the-wp-fitness' ),
        'section' => 'the_wp_fitness_advance_options'
    ));

    $wp_customize->add_setting('the_wp_fitness_breadcrumb_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_breadcrumb_color', array(
		'label'    => __('Breadcrumb Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_advance_options',
	)));

	$wp_customize->add_setting('the_wp_fitness_breadcrumb_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_breadcrumb_background_color', array(
		'label'    => __('Breadcrumb Background Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_advance_options',
	)));

	$wp_customize->add_setting('the_wp_fitness_breadcrumb_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_breadcrumb_hover_color', array(
		'label'    => __('Breadcrumb Hover Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_advance_options',
	)));

	$wp_customize->add_setting('the_wp_fitness_breadcrumb_hover_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_breadcrumb_hover_bg_color', array(
		'label'    => __('Breadcrumb Hover Background Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_advance_options',
	)));
    ...
    $wp_customize->add_setting( 'the_wp_fitness_toggle_button_bg_color_settings', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'the_wp_fitness_toggle_button_bg_color_settings', array(
  		'label' => __('Toggle Button Bg Color', 'the-wp-fitness'),
	    'section' => 'the_wp_fitness_responsive_options',
	    'settings' => 'the_wp_fitness_toggle_button_bg_color_settings',
  	)));
	...
	$wp_customize->add_setting('the_wp_fitness_backtotop_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'the_wp_fitness_sanitize_checkbox'
	));
	$wp_customize->add_control('the_wp_fitness_backtotop_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Back to Top','the-wp-fitness'),
      	'section' => 'the_wp_fitness_responsive_options',
	));

	$wp_customize->add_setting( 'the_wp_fitness_sidebar_hide_show',array(
      'default' => true,
      'sanitize_callback'	=> 'the_wp_fitness_sanitize_checkbox'
    ));
    $wp_customize->add_control('the_wp_fitness_sidebar_hide_show',array(
      'type' => 'checkbox',
      'label' => esc_html__( 'Enable Sidebar','the-wp-fitness' ),
      'section' => 'the_wp_fitness_responsive_options'
    ));
    ...
    $wp_customize->add_setting('the_wp_fitness_shop_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'the_wp_fitness_sanitize_choices',
	));
	$wp_customize->add_control('the_wp_fitness_shop_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Shop Page layout', 'the-wp-fitness'),
		'section'        => 'the_wp_fitness_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'the-wp-fitness'),
			'Right Sidebar' => __('Right Sidebar', 'the-wp-fitness'),
    ...
    $wp_customize->add_setting('the_wp_fitness_single_product_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'the_wp_fitness_sanitize_choices',
	));
	$wp_customize->add_control('the_wp_fitness_single_product_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Single Product Page Layout', 'the-wp-fitness'),
		'section'        => 'the_wp_fitness_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'the-wp-fitness'),
			'Right Sidebar' => __('Right Sidebar', 'the-wp-fitness'),
	...
	$wp_customize->add_setting('the_wp_fitness_back_to_top_text_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_back_to_top_text_color', array(
		'label'    => __('Back To Top Text Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_copy_text',
	)));

	$wp_customize->add_setting( 'the_wp_fitness_footer_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'the_wp_fitness_sanitize_checkbox'
    ));
    $wp_customize->add_control('the_wp_fitness_footer_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Footer','the-wp-fitness' ),
      'section' => 'the_wp_fitness_copy_text'
    ));
    ...
    $wp_customize->add_setting('the_wp_fitness_widgets_heading_fontsize',array(
		'default'	=> 30,
		'sanitize_callback'	=> 'the_wp_fitness_sanitize_float',
	));	
	$wp_customize->add_control('the_wp_fitness_widgets_heading_fontsize',array(
		'label'	=> __('Footer Widgets Heading Font Size','the-wp-fitness'),
		'section'	=> 'the_wp_fitness_copy_text',
		'type'		=> 'number'
	));

	$wp_customize->add_setting('the_wp_fitness_widgets_heading_font_weight',array(
        'default' => '',
        'sanitize_callback' => 'the_wp_fitness_sanitize_choices'
    ));
    $wp_customize->add_control('the_wp_fitness_widgets_heading_font_weight',array(
        'type' => 'select',
        'label' => __('Footer Widgets Heading Font Weight','the-wp-fitness'),
        'section' => 'the_wp_fitness_copy_text',
        'choices' => array(
            '100' => __('100','the-wp-fitness'),
            '200' => __('200','the-wp-fitness'),
    ...
    $wp_customize->add_setting('the_wp_fitness_footer_widgets_heading',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'the_wp_fitness_sanitize_choices'
	));
	$wp_customize->add_control('the_wp_fitness_footer_widgets_heading',array(
    'type' => 'select',
    'label' => __('Footer Widget Heading Alignment','the-wp-fitness'),
    'section' => 'the_wp_fitness_copy_text',
    'choices' => array(
    	'Left' => __('Left','the-wp-fitness'),
        'Center' => __('Center','the-wp-fitness'),
	...
	$wp_customize->add_setting('the_wp_fitness_footer_widgets_content',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'the_wp_fitness_sanitize_choices'
	));
	$wp_customize->add_control('the_wp_fitness_footer_widgets_content',array(
    'type' => 'select',
    'label' => __('Footer Widget Content Alignment','the-wp-fitness'),
    'section' => 'the_wp_fitness_copy_text',
    'choices' => array(
    	'Left' => __('Left','the-wp-fitness'),
        'Center' => __('Center','the-wp-fitness'),
    ...
    $wp_customize->add_setting( 'the_wp_fitness_copyright_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'the_wp_fitness_sanitize_checkbox'
    ));
    $wp_customize->add_control('the_wp_fitness_copyright_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Copyright','the-wp-fitness' ),
      'section' => 'the_wp_fitness_copy_text'
    ));

    $wp_customize->add_setting('the_wp_fitness_copyright_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_copyright_bg_color', array(
		'label'    => __('Copyright Background Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_copy_text',
	)));

	$wp_customize->add_setting('the_wp_fitness_copyright_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'the_wp_fitness_copyright_color', array(
		'label'    => __('Copyright Color', 'the-wp-fitness'),
		'section'  => 'the_wp_fitness_copy_text',
	)));
		...
		$manager->add_section(
			new The_WP_Fitness_Customize_Section_Pro(
				...
				array(
					...
					'pro_text' => esc_html__( 'Get Pro', 'the-wp-fitness' ),
